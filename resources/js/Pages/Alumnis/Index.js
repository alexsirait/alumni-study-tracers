    ...
    return (
        <Authenticated
            ...
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight flex items-center gap-x-2">
                        ...
                        <span>Users Alumni</span>
                    </h2>}
        >
            <Head title="Users Alumni" />
                    ...
                    <div className="flex items-center justify-end">
                        <div className='w-1/2'>
                            <div className="flex item-center justify-start gap-x-2 mb-6">
                                <Link href={route('alumni.create')} className='inline-flex items-center justify-center h-10 px-6 font-medium tracking-wide text-black shadow-md transition duration-200 bg-white rounded-lg hover:bg-gray-50 focus:shadow-outline focus:outline-none'>
                                ...
                                <Menu as='div' className='relative'>
                                    ...
                                    <Menu.Items as='div' className='absolute left-20 bg-white w-52 border shadow-sm rounded-lg py-0.5 top-0'>
                                        ...
                                        <Menu.Item>
                                            <a className='py-2.5 px-4 block hover:bg-gray-50' href={route('import.alumni.create')}>
                                                <div className='flex items-center gap-x-2'>
                                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                                        ...
                                        <Menu.Item>
                                            <a className='py-2.5 px-4 block hover:bg-gray-50' href="https://docs.google.com/spreadsheets/d/18lgDZKGYj-6uCzdsq0qTRmeXQZHAwRvb/export?formatxlsx&#gid=633342621" target="_blank">
                                                <div className='flex items-center gap-x-2'>
                                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                                ...
                                {showExport && 
                                    <DialogModal
                                        ...
                                        content='Are you sure you want to export all Alumni data ?'
                                    >
                                        ...
                                        <a href={route('alumni.export')} className='inline-flex items-center justify-center h-10 px-6 font-medium tracking-wide text-white shadow-md transition duration-200 bg-gray-800 rounded-lg hover:bg-gray-700 focus:shadow-outline focus:outline-none' onClick={(e)=>setShowExport(false)}>
                                            Export
                                        </a>
                                    </DialogModal>
                                }
                                ...
                                {showDeleteAll && 
                                    <DialogModal 
                                        ...
                                        content='Are you sure you want to delete all Alumni users ?'
                                    >
                                        ...
                                        <Link method='delete' as="button" href={route('alumni.alldelete')} className='inline-flex items-center justify-center h-10 px-6 font-medium tracking-wide text-white shadow-md transition duration-200 bg-gray-800 rounded-lg hover:bg-gray-700 focus:shadow-outline focus:outline-none' onClick={(e)=>setShowDeleteAll(false)}>
                                            Delete
                                        </Link>
                                    </DialogModal>
                                }
                                    ...
                                    >
                                        ...
                                        <div className='flex items-start text-left mb-4 border rounded-md p-2'>
                                            <table className="flex items-center px-4">
                                                <tbody>
                                                    <tr>
                                                        <td className='text-gray-700 text-md font-semibold' width={`100px`}>NIM</td>
                                                        <td>:</td>    
                                                    ...
                                                    <tr>
                                                        <td className='text-gray-700 text-md font-semibold'>Prodi</td>
                                                        <td>:</td>    
                                                        <td className='px-2 py-1 text-gray-800 text-md font-bold'>{dataUser.prodi}</td>
                                                    </tr>
                                                    <tr>
                                            ...
                                            <table className="flex items-center">
                                                <tbody>
                                                    <tr>
                                                        <td className='text-gray-700 text-md font-semibold' width={`100px`}>Telp</td>
                                                        <td>:</td>    
                                                        <td className='px-2 py-1 text-gray-800 text-md font-bold'>{dataUser.telp}</td>
                                                    </tr>
                                                    <tr>
                                                        <td className='text-gray-700 text-md font-semibold'>Kelamin</td>
                                                        <td>:</td>    
                                                        <td className='px-2 py-1 text-gray-800 text-md font-bold'>
                                                            {dataUser.kelamin == 'L' ? 'Laki-laki' : dataUser.kelamin == 'P' ? 'Perempuan' : dataUser.kelamin}
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td className='text-gray-700 text-md font-semibold'>IPK</td>
                                                        <td>:</td>    
                                                        <td className='px-2 py-1 text-gray-800 text-md font-bold'>{dataUser.ipk}</td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
                                                        ...
                                                        <Menu>
                                                            ...
                                                            <div className='relative'>
                                                                <Menu.Items as='div' className='absolute right-32 bg-white w-52 border shadow-sm rounded-lg py-0.5 top-0'>
                                                                    ...
                                                                    <Menu.Item>
                                                                        <Link as='a' className='py-2.5 px-4 block hover:bg-gray-50' href={route('alumni.edit', person.id)}>
                                                                            <div className='flex items-center gap-x-2'>
                                                                                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
