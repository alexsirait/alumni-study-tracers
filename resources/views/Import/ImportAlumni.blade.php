...
<head>
    ...
    <title>Import Alumni - Tracer Study Polibatam</title>
...
<body>
    <div class="bg-transparent bg-gray-800 bg-opacity-25 flex justify-center items-center absolute top-0 right-0 bottom-0 left-0 animate-fade">
        <div class="bg-white px-56 shadow-2xl py-14 rounded-3xl text-center">
            ...
            <div class="mb-6">
                <span class="block mb-3 text-md tracking-tight font-sans font-semibold">Import Alumni Data</span>
            </div>
            <form class="items-center" action="{{ route('import.alumni.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="mb-6">
                ...
                <a href="{{ route('alumni.index') }}" class="inline-flex items-center justify-center h-10 px-6 font-medium tracking-wide text-black shadow-md transition duration-200 bg-white rounded-lg hover:bg-gray-50 focus:shadow-outline focus:outline-none mr-2">Cancle</a>
