...
class KuesionerAlumniELExport implements FromView, WithDrawings, ShouldAutoSize
{
    public function view(): View
    {
        $data['laporan_kuesioner_alumni'] = KuesionerAlumni::where('a9', 'Teknik Elektronika')->get();
